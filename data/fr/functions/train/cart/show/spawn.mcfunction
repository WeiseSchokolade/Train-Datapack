...
summon minecraft:armor_stand -194 68 191 {Tags:["train","train1","cart"],NoGravity:1b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:knowledge_book",Count:1b,tag:{CustomModelData:13000}}],DisabledSlots:4144959}
